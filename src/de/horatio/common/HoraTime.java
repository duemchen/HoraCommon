...
/**
 * TODO Doku bei Verwendung von SimpleDateFormat bei der Initialisierung das
 * Wunschland mit angeben (LVMA: Länderformate)
 *
...
public class HoraTime {
    ...
    /**
     * vereinbart als leere Datumseingabe für JahreskappungStichtag
     * JahreskappungStichtag2
     */
    ...
    /**
     * Diese Funktion wandelt ein Date-Object in einen String der Form
     * 01.01.2005 12:00:00
     *
     * @param date Zeit in Date-Format
    ...
    /**
     * Diese Funktion wandelt den Uhrzeiteintrag der Datenbank in HH:MM. Kann
     * auch 24:00 und grösser sein!! Beispiel: 0.5 --> 12:00 0.75 --> 18:00
     *
    ...
    /**
     * Diese Funktion wandelt den Uhrzeiteintrag der Datenbank in HH:MM. K auch
     * 24:00 und grösser sein!! Beispiel: 0.25 --> 6:00 0.5 --> 12:00 0.75 -->
     * 18:00
     *
     * @param zeit als double-Wert
     * @return vz Zeit als String
    ...
    /**
     * Diese Funktion wandelt den Uhrzeiteintrag der Datenbank in HH:MM oder
     * Dezimal. Kann auch 24:00 und grösser sein!! Beispiel: 0.5 --> 12:00 0.75
     * --> 18:00
     *
     * @param zeit als double-Wert
     * @param hhmm als boolean-Wert
     * @return Uhrzeit aus double wird entweder zu HHMM oder Industriezeit
     * gewandelt.
     * @since
     */
    ...
    /**
     * Diese Funktion wandelt nur die Minuten des doubles der Datenbank in HH:MM
     * oder Dezimal. Dabei bleiben die Stunden so vorhanden wie sie uebergeben
     * wurden. Kann auch 24:00 und grösser sein!! Beispiel: 12.0 --> 12:00 18.75
     * --> 18:45
     *
     * @param zeit als double-Wert
     * @param hhmm als boolean-Wert
    ...
    /**
     *
     * Convert string in ##,## format to float value Returns null on convert
     * error
     *
    ...
    /**
     * Test, ob ein String Zeit-Datum enthält "19.08.2003 15:06:41" besser
     * String in Calendar einsetzen und bei Fehler exception auswerten !!
     *
     * @param sTest
     * @return true / false
     */
    ...
    /**
     * Diese Funktion prüft ein Datum auf Wochenende. Ist das Datum ein SA oder
    ...
    /**
     * Diese Funktion macht aus einem long-Wert einen String der Form hh:mm
     *
     * @param l long
   ...
   return result;
    ...
    /**
     * Diese Funktion gibt true zurück, wenn der Zeitraum a..b vollständig im
     * Zeitraum von..bis ist
     *
     * @param a long
     * @param b long
     * @param von long
    ...
    /**
     * Diese Funktion liefert einen Zeitstempel als String-Object der Form
     * 12:00:00
     *
    ...
    /**
     * für Link-Absicherung versteckter Zeitstempel
     *
     * @param now
     * @return
     */
    ...
    /**
     * für Link-Absicherung versteckten Zeitstempel mit Systemzeit vergleichen
    ...
    public static boolean ueberlappung(Date persvon, Date persbis, Date von, Date bis) {
        ...
        } else if (persvon.getTime() >= von.getTime() && persvon.getTime() <= bis.getTime()) {
            hatUeberlappung = true;
        } else if (persbis.getTime() >= von.getTime() && persbis.getTime() <= bis.getTime()) {
            hatUeberlappung = true;
        }
     ...
     * @return
     *
     * morgen vor einem Jahr Dümchen 2011/10/25
     */
    ...
    public static boolean imZeitraum(String v, String b) {
        ...
        int now = toMinuten(HoraTime.ZeitStempel());
        boolean result = (von <= now) && (now < bis);
        if (negate) {
            result = !result;
        }
        // System.out.println(HoraTime.ZeitStempel() + " imZ " + v + ", " + b + " -> " + result);
        return result;
    }

    private static int toMinuten(String uhr) {
        String[] x = uhr.split(":");
        int result = 0;
        if (x.length > 1) {
            result = Integer.parseInt(x[0]) * 60 + Integer.parseInt(x[1]);
        }
        return result;
    }
